import { buildNavCommands } from "../commands/navCommands";
...
import { AppPort, Pipeline, Transform } from "../core/types";

export const buildParseInput = (ap: AppPort) => {
	const stateCommands = buildStateCommands(ap);
